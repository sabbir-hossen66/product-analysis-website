    ...
    return (
        ...
        <ul>
            ...
            <li className='semantic-design'>
                Semantic tag: html is a markup language.here, there are different kind of tag.A semantic element clearly describes it's meaning to both the browser and the developer. semantic is one of them.such as- .*article,
                *aside.
                *footer.
                *header.
                *nav-.
